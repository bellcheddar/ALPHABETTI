...
- **The logo is 3D and interactive**, not a picture. Four arrangements: **helix** (a spiral tower, the default and the right one for a long family), **ring** (a crown you orbit or drop into), **strip** and **rows**. Orbit it, zoom right down to one column, click a column to pin its counts and go there. The flat layouts sit square to the camera and a click centres and zooms in two dimensions rather than rotating, because a sheet of text is for reading, not orbiting.
